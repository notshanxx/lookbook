...
syncToGoogleBtn.addEventListener("click", () => {
  ...
  if (
    !confirm(
      "Your Saved Books will be Synced to Google Books. Are you sure you want to continue?"
    )
  ) {
    return;
  }
  ...
  const client = google.accounts.oauth2.initTokenClient({
    client_id:
      "695259268184-fjn31kr2gpj39jks7udk93s1lonvclk6.apps.googleusercontent.com",
